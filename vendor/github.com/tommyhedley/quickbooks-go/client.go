...
func (c *Client) req(params RequestParameters, method string, endpoint string, payloadData interface{}, responseObject interface{}, queryParameters map[string]string) error {
	fmt.Printf("starting request for: %s\n", endpoint)
	...
	fmt.Println("global concurrent slot aquired")
	...
	fmt.Println("global rate limit allowed")
	...
	fmt.Println("realm rate limiter allowed")
	...
	fmt.Println("realm concurrent slot aquired")
	...
	fmt.Println("request parameters created")
